...
import { TOOLS, CATEGORIES, type ToolCategory, type ToolDefinition } from "@/data/tools";
    ...
    <div className="space-y-5">
      <div className={`flex flex-col gap-3 ${compact ? "" : "sm:flex-row"}`}>
        <div className="relative flex-1">
          ...
          <input
            type="search"
            placeholder="Search json formatter, jwt decoder..."
            value={query}
          ...
          {grouped ? (
            <div className="space-y-10">
              {CATEGORIES.map((cat) => {
                ...
                return (
                  <section key={cat}>
                    <h2 className="section-title mb-4">{cat}</h2>
